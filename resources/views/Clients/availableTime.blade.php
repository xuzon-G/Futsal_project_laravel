 	...
 	<div class="modal-dialog">
 		<div class="modal-content">
 			...
 			<div class="modal-body">
				<div class="form">
 				<form class="form-horizontal" action="/bookNow" method="post">
          {{csrf_field()}}
			  	...
			  	<div class="form-group">
    				...
    				<div class="col-sm-9"> 
     			    <input type="tel" name="phone"  required class="form-control" id="phone" placeholder="9840000000"  pattern="[0-9]{3}[0-9]{3}[0-9]{4}" >
    			</div>
  				</div>
